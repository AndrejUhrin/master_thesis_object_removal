...
pred_base = project_root / "results_pipeline_optimization_dataset" / "results_initial_pipeline" / "json_results"
gt_base = project_root / "ground_truth_dataset"
store = project_root / "validation_on_gt" / "results_initial_pipeline"
csv_path = store / "detection_metrics.csv"

...
pred_base    = project_root / "post_filtering_results" / "clip_postfiltering_results" / "json_results_clip_filtering"
gt_base      = project_root / "ground_truth_dataset"
store        = project_root / "validation_on_gt" / "clip_postfiltering"
csv_path     = store / "detection_metrics_clip_postfiltering.csv"

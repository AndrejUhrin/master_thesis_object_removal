...
pred_base = project_root / "post_filtering_results" / "gpt_postfiltering_results" / "json_results_gpt_filtering"
gt_base = project_root / "ground_truth_dataset"
store = project_root / "validation_on_gt" / "gpt_postfiltering_results"
csv_path = store / "detection_metrics_gpt.csv"

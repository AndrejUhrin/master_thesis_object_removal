...
pred_base = project_root / "archived" / "run_files_archived" / "archived_results" /"minimum_threshold_needed" / "json_results_post"
gt_base = project_root / "ground_truth_dataset"
store = project_root / "archived" / "run_files_archived" / "archived_validation" /"minimum_threshold_needed" 
csv_path = store / "detection_metrics_minimum_threshold.csv"

def load_gt_mask(mask_path: Path):
    """
    Reads a white-on-black mask image, finds all connected white
    components, returns their bounding boxes + the mask.
    """
